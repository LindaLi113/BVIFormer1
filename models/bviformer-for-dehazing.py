...
class SKFF1(nn.Module):
    def __init__(self, in_channels: int, height: int=2, reduction: int=8, bias: bool=False):
        super().__init__()
        self.height = height
...
class BVIFormer(nn.Module):
    def __init__(self,
        ...
        self.aggregate1 = SKFF1(in_channels=96, height=2)
        ...
        self.aggregate2 = SKFF1(in_channels=384, height=2)
        ...
        self.aggregate3 = SKFF1(in_channels=1536, height=2)
        ...
        self.up_aggregate1 = SKFF1(in_channels=384, height=2)
        ...
        self.up_aggregate2 = SKFF1(in_channels=96, height=2)
        ...
        self.up_aggregate3 = SKFF1(in_channels=48, height=2)
